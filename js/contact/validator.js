...
var post_data = function() {
	...
	form.fail(function() {
		$('form').parent().prepend('<p class="error">I\'m sorry, their was an unknown error sending the message. If this keeps happening you can contact me by emailing xuhengfei.me[at]gmail[dot]com, or using any of the social networks listed in the left. Sorry about that. </p>');
	});
}
